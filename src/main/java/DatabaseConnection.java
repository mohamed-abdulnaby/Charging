...
public class DatabaseConnection {
    ...
    // NeonDB (Production)
    private static final String NEON_HOST = "db";
    private static final String NEON_DB = "neondb";
    private static final String NEON_USER = "postgres";
    private static final String NEON_PASSWORD = "***REDACTED***";

    // Local Docker PostgreSQL
    private static final String LOCAL_HOST = "localhost";
    private static final String LOCAL_DB = "charging";
    private static final String LOCAL_USER = "postgres";
    private static final String LOCAL_PASSWORD = "***REDACTED***";
